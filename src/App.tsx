        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            <div className="flex gap-6">
              <a href="#about" className="text-xs font-bold tracking-[0.2em] hover:text-red-600 transition-colors uppercase">{t.nav.about}</a>
              <a href="#games" className="text-xs font-bold tracking-[0.2em] hover:text-red-600 transition-colors uppercase">{t.nav.games}</a>
              <a href="#contact" className="text-xs font-bold tracking-[0.2em] hover:text-red-600 transition-colors uppercase">{t.nav.contact}</a>
            </div>
          </div>
